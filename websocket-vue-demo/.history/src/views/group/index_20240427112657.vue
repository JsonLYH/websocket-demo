<template>
    <div>
        <button @click="cookieAddTest">跨域cookie存储测试</button>
...
export default {
    ...
    methods: {
        cookieAddTest() { 
            ...
            instance.get("http://localhost:8080/api/v1/cookie/test")
        },
        send() {
            if (this.stompClient) {
        ...
        init() {
            ...
            let socket = new SockJS("http://localhost:8080/endpoint-websocket", null, {
                withCredentials:true
            });
